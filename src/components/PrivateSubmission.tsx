...
import { PrivateCharges } from "./PrivateCharges"
import { PrivateRequestSignature } from "./PrivateRequestSignature"
...
import { PrivateSetComplainant } from "./PrivateSetComplainant"
...
export const PrivateSubmission = ({ new_submission }: SubmissionProps) => {
  ...
  const [complainantType, setComplainantType] = useState('adult')
  ...
  const complainantTypeChange = (event: any) => {
  ...
  const complainantSaved = async (complainant: any) => {
    ...
    setComplainantPhone(complainant.phone)
            ...
            <div id="regForm" className="fade show m-0 py-0">
              <div>
                ...
                <div className="container p-0 mb-3">
                  <div className="row">
                    <div className="col col-10 d-flex justify-content-start">
                      <button className="btn btn-link me-2" onClick={() => handleSectionChange('complainant')}>My Information</button>
                      ...
                      <button className="btn btn-link" onClick={() => handleSectionChange('summary')}>Ready to Sign</button>
                ...
                <div className="px-2 py-2 d-flex align-items-center" style={{ backgroundColor: "#333", color: "#fff" }}>
                  ...
                  <h5 className="fw-bold mx-3 mb-0 flex-grow-1">Private Complaint {submissionTitleSaved ? '(' + submissionTitle + ')' : ''}</h5>
                    ...
                    <form onSubmit={saveTitle} >
                      <fieldset>
                        <div className="form-group field field-string">
                          ...
                          <label id="" className="control-label fs-5">
                            Title of your complaint <a
                          ...
                          <div className=" mt-2">
                            ...
                            {!submissionTitleSaved ?
                              <>
                                <label className="control-label fs-5  my-2">
                                  Who am I ?
                                </label>
                      ...
                      {(!submissionComplainantSaved || editingSubmissionComplainant) && editable ?
                        <div>
                          ...
                          <div className="card fade show m-3" style={{ border: "none", backgroundColor: "#ddd" }} >
                            <h4 className="text-center mt-3 mb-1">Provide your full name and contact information</h4>
                        ...
                        <>
                          ...
                          <div className="card fade show p-2" style={{ border: "none" }}>
                            ...
                            <div className="px-2 py-2 d-flex align-items-center" style={{ backgroundColor: "#444", color: "#fff", borderBottom: "1px solid #ddd" }}>
                              <h5 className="fw-bold m-0 px-2 flex-grow-1 text-left">Your Information</h5>
                              {!submissionTitleSaved || editingSubmissionTitle ?
                                <></>
                                : <>
                                  {/* <a href="#" className="small" onClick={editTitle}>Edit Title</a> */}
                            ...
                            <div className="card-body" style={{ border: "1px solid #ddd", backgroundColor: "#eee" }}>
                              <div className="text-left complainant-details mt-2">
                                ...
                                <br /><label>Phone:</label> {complainantPhone}
                              </div>
                  ...
                  <div className="container p-0 mb-3">
                    <div className="row">
                      ...
                      <div className="col col-6 d-flex justify-content-end">
                        <button className="btn btn-link" onClick={() => handleSectionChange('summary')}>
                          Next: Ready to sign <i className="fa fa-expand"></i> <FontAwesomeIcon icon={faAngleDoubleRight} /></button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div id="swf-summary" style={{ display: visibleSections.summary || visibleSections.all ? 'block' : 'none' }}>
                  ...
                  {(hasAccused && charge_count > 0) ?
                    <div className="" style={{ backgroundColor: "#fff", border: "10px solid #eee", borderRadius: "none!important" }}>
                      <h5 className="fw-bold m-0 mt-4 mb-2 px-2 flex-grow-1 text-center">Ready To Sign</h5>
                      <PrivateRequestSignature submission_id={submissionId} complainant_email={complainantEmail} />
                    </div>
                    : <></>
                  }
                </div>
