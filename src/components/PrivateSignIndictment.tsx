...
export const PrivateSignIndictment = ({ submission_id, complainant_email, submissionType, complainant_rank, complainant_name, complainant_regnum, already_signed, already_verified }: SignIndictmentProps) => {
    ...
    const phraseSign = async (event: any) => {
        event.preventDefault()
        ...
        try {
            ...
            axios.post(`${API_URL}/api/submissions/phrasesign_submission`,
                {
                    submission_id: submission_id,
                    email: signing_email,
    ...
    useEffect(() => {
        (async () => {
            ...
            setVerificationMode(config.data.mode)
        })();
    }, [])
            ...
            {otpSent && !signed && !already_signed ?
                ...
                <select className='form-select' value={commissionedEmail} onChange={commisionedChange}>
                    ...
                    { verificationMode == "OTP" ?
                        ...
                        :
                        <>
                            <form onSubmit={phraseSign}>
                                <div className="" style={{}}>
                                    <br />

                                    <div className="text-center mb-2" style={{ fontSize: "11pt", margin: "0 20px" }}>
                                        Paste the 12 word emergency pass phrase that was sent to your email into the box below to authenticate and complete the signing process..
                                    </div>
                                    <div className="text-center mb-4">
                                        <div style={{ display: "block", margin: "0 auto", width: "200px" }}><input
                                            type="text"
