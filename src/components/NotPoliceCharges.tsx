...
import NotPoliceAccusedList from "./NotPoliceAccusedList";
import Add from "./Add"
...
export const NotPoliceCharges = ({submission_id, request_signature, editable}: ChargesProps) => {
    ...
    return (
        <Provider store={store}>
            ...
            <div className="px-2 py-2 d-flex align-items-center" style={{ backgroundColor:"#444", color:"#fff", borderBottom: "1px solid #ddd" }}>
                <h5 className="fw-bold m-0 px-2 flex-grow-1 text-left">Warrants / Summons Accuseds</h5>
