    ...
    return (
        <>
            ...
            <>
              ...
              <div style={{ padding: '5px 30px', borderTop:"1px solid #bbb", 
              position:"fixed", bottom:"0px", width:"100%", backgroundColor: '#ccc', color: 'white' }}>
              <div>
      
                  <div className="copyright">
                    <span className="jtt-logo-bottom mb-3">
                      <img  width="15" src={jttSmall} />
                    </span>
                    &nbsp; &nbsp;
                    <span>
                    <a style={{color:"#777", fontSize:"12px", textDecoration:"none"}} href="https://www.ttlawcourts.org">Copyright © {year}. Judiciary of Trinidad and Tobago. All Rights Reserved</a>
                    </span>
                    &nbsp; &nbsp;
                    <span><a href="https://eservices.ttlawcourts.org" target="_blank"><img width="auto" height="15" className="logo-eservices" src={eservicesLogo} /></a></span>
                    </div>
