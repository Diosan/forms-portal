...
const IndictmentAccusedList = ({submission_id, request_signature, submission_accuseds, editable, onAccusedRemoved}: AccusedListProps) => {
...
export default IndictmentAccusedList