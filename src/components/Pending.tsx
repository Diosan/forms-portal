...
export const Pending = ({ first_name, last_name, accused_id, key }: OffencesProps) => {
    ...
    useEffect(() => {
        ...
        const fetchPendings = async () => {
            let charges = await axios.get(API_URL + "/api/accuseds/pendings/" + accused_id);
            const groupedOffences = { ...pendings };

            groupedOffences[accused_id] = charges.data.pendings;
        ...
        <>
            {Object.keys(pendings).map((index, accused_id) => (
                ...
                <div key={index}  style={{margin:"0 0 20px 0", padding:"0"}}>
                    ...
                    <div style={{}}>
                    <label style={{ fontSize: "10pt", margin:"0 0 7px 0" }}>Pending</label>
