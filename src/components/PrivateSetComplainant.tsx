...
export const PrivateSetComplainant = ({submission_id, adult_only, complainant_added, complainant_saved, saved_complainant}: SetComplainantProps) => {
    ...
    const saveComplainant = async (event: any) => {
        ...
        console.log('\n\n\n complainantPhone is set to ' + complainantPhone + '\n\n\n')
    ...
    return (
            ...
            <form onSubmit={saveComplainant} className="m-3">
                ...
                {/* <div className="mb-3">
                <select className='form-select' id="agency" value={complainantAgency} onChange={complainantAgencyChange} required disabled>
                ...
                <div className="mb-3">
                <input type="phone" className="form-control" id="phone" value={complainantPhone} onChange={complainantPhoneChange} placeholder="Phone Number" required />
                </div>
