...
export const Sign = ({ }: SignProps) => {
    ...
    return (
        <div id="page-sign" className=" container-pdf">



            <div className="container submissions-container mobile-responsive" style={{ borderRadius: "5px", maxWidth: "900px", padding: "20px 40px", margin: "30px 30px 30px 300px", flexGrow: 1 }}>
                ...
                {status === "charge_saved" ? (
                    <div className="swf-note">
                        ...
                        <h6 className='mb-4' style={{ color: "blue", lineHeight: "1.4rem" }}>After ensuring accuracy, click '<strong>Request Signing Code</strong>' to continue.</h6>
                    </div>
                ) : status === "final" ? (
                ...
                <div id="page-view-inner">
                        ...
                        <div className="swf-content card fade show">
                        ...
                        {/* SIGNING BOX */}
                        <div className="text-left complainant-details swf-sign"
                            style={{
                                // width: "750px",
                                maxWidth: "750px",
                            ...
                            <div id="anchorSign" className="signing"></div>
                            <SignIndictment
